...
create_dat <- function(out, case = "T1A-D1",
  ...
  optdt = 0, optdet = 0, optsur = 0, ntrial = 400, nyear = 100, npcat = 30,
  nprot = 0, msyl = 0.6, msyr1 = 0.01, depl = 0.99, k99 = 0.000, msyr99 = 0.000,
  istep = 0, mat1 = 7.00, erate = 0.00, component = 1, ifreq = 5, bias0 = 0,
  ...
  dat[38] <- paste0("YEAR OF LAST SURVEY                  ENDSUR ", nyear + 1)
  dat[39] <- paste0("YEAR CV CHANGES                      IYRCV  ", nyear + 1)
  dat[40] <- paste0("BIAS IN ABUNDANCE ESTIMATES          BIAS0    ", bias0)
